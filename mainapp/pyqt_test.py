...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.port_label.setFixedSize(250, 15)

        # Поле для ввода номера порта
        self.port = QLineEdit(self)
        self.port.move(235, 107)
        ...
        self.ip_label_note = QLabel('(Oставьте это поле пустым, чтобы принимать соединения с любых адресов.)', self)
        self.ip_label_note.move(10, 170)
        self.ip_label_note.setFixedSize(600, 30)

        # Поле для ввода ip
        self.ip = QLineEdit(self)
        self.ip.move(270, 148)
